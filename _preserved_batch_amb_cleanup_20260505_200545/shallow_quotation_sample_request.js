...
// Adds a button to create Sample Request AMB from Quotation
// Version: 2026-03-17
// =============================================================================

frappe.ui.form.on('Quotation', {
    refresh: function(frm) {
        console.log('🔧 Quotation Refresh triggered for:', frm.doc.name);
        
        // Add Sample Request button for existing quotations
        if (!frm.is_new()) {
            frm.add_custom_button(__("Sample Request"), function() {
                frappe.call({
                    method: 'amb_w_tds.amb_w_tds.doctype.batch_amb.batch_amb.create_sample_request_from_quotation',
