...
class COAAMB2(Document):
    ...
    def before_save(self):
        ...
        # to be reviewed freezed on save COA AMB2 document
    ...
    def generate_coa_pdf(self):
        ...
        try:
            ...
            frappe.log_error(f"Error generating COA PDF: {str(e)}", "COA AMB2 - PDF Generation")
    ...
    def update_batch_status(self, status=None):
        ...
        try:
            ...
            frappe.log_error(f"Error updating batch {self.batch_reference}: {str(e)}", "COA AMB2 - Batch Update")
    ...
    def notify_quality_team(self):
        ...
        if recipients:
            try:
                ...
                frappe.log_error(f"Error sending COA notification: {str(e)}", "COA AMB2 - Notification")
    ...
    def create_quality_audit(self):
        ...
        try:
            ...
            frappe.log_error(f"Error creating quality audit: {str(e)}", "COA AMB2 - Audit Creation")
    ...
    def update_product_quality_status(self):
        ...
        try:
            ...
            frappe.log_error(f"Error updating product quality status: {str(e)}", "COA AMB2 - Product Update")
    ...
    def revert_product_quality_status(self):
        ...
        try:
            ...
            frappe.log_error(f"Error reverting product quality status: {str(e)}", "COA AMB2 - Product Revert")
...
def validate_all_tests(coa_name):
    ...
    try:
        coa = frappe.get_doc('COA AMB2', coa_name)
...
def duplicate_coa(source_coa, new_batch=None):
    ...
    try:
        source = frappe.get_doc('COA AMB2', source_coa)
        
        # Create new COA
        new_coa = frappe.new_doc('COA AMB2')
...
def validate_cav_on_submit(doc, method=None):
    """On COA AMB2 submit, cross-reference each measured parameter row against
