...
fixtures = [
    ...
    # G-1a (2026-09-09) — mixing equipment catalogue. Values are carried in the
    # fixture explicitly, never inherited from a DocType default (rule z).
    {"doctype": "Mixing Equipment"},
